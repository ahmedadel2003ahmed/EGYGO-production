...
export default function LegacyPaymentCancelRedirect() {
  ...
  useEffect(() => {
    ...
    console.log('Detected incorrect cancel redirect. Fixing...');
    console.log('Extracted tripId:', tripId);
    
    if (tripId) {
      // Redirect to correct URL
      const correctUrl = `/payment/cancel?trip_id=${tripId}`;
      ...
      // If we can't extract ID, go to trips list
      setTimeout(() => {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Payment cancelled. We&apos;re redirecting you to the correct page.
        </p>
